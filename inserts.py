...
# 4 - create users
john = User("John Snow", "M", date(2002, 10, 11), "some text...", 42, 3, "+30676539846", "john.snow@zalupa.com",
    "facebook.john.snow", "instagram.john.snow", "twitter.john.snow",
        "password", "USA", "Denver", 4, date(2018, 10, 11), date(2002, 10, 11), False)
smith = User("Smith Snow", "M", date(2002, 10, 11), "some text...", 42, 3, "+30676539846", "smith.snow@zalupa.com",
    "facebook.smith.snow", "instagram.smith.snow", "twitter.smith.snow",
        "password", "USA", "Denver", 4, date(2018, 10, 11), date(2002, 10, 11), False)
alex = User("Alex Snow", "M", date(2002, 10, 11), "some text...", 42, 3, "+30676539846", "alex.snow@zalupa.com",
...
some_event_2 = Event("Sport talking", 3, "John", date(2002, 10, 11), 5, 3, date(2002, 10, 11), date(2002, 10, 11))
some_event_3 = Event("Sport talking", 3, "John", date(2002, 10, 11), 5, 3, date(2002, 10, 11), date(2002, 10, 11))
